...
const extractImagesFromPdf = (pdfPath, outputDir) => {
  return new Promise((resolve, reject) => {
    ...
    const poppler = spawn("/usr/bin/pdftoppm", [
      "-png",
      "-r",
      "70",        // DPI (high quality)
      pdfPath,
...
//       // Add a short delay to allow file locks to release
//       setTimeout(() => {
//         try {
//           // Read generated images
//           const files = fs
...
//                   const waitMs = 300;
//                   console.log(`EBUSY on ${file}, retrying in ${waitMs}ms... (${attempts} left)`);
//                   // Synchronous wait (not ideal in prod, but simple for this context)
...
//           reject(err);
//         }
//       }, 500); // 500ms delay; adjust if needed (e.g., 800ms for slower systems)
//     });
//   });
// };
